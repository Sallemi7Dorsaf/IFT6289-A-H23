...
from word2vec import word2vec_sgd_wrapper, skipgram, cbow, neg_sampling_loss_and_gradient
...
word_vectors = sgd(
    ...
    word_vectors, 0.2, 35000, tokens, None, True, PRINT_EVERY=10, model="skip-gram")
...
word_vectors = sgd(
    lambda vec: word2vec_sgd_wrapper(cbow, tokens, vec, dataset, C,
                                     neg_sampling_loss_and_gradient),
    word_vectors, 0.2, 35000, tokens, None, True, PRINT_EVERY=10, model="CBOW")
